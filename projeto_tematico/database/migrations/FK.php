...
class FK extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('movimentos', function (Blueprint $table) {
            ...
            $table->foreign('operadorid')->references('id')->on('operedores')->onDelete('cascade');
        ...
        Schema::table('pratelerias', function (Blueprint $table) {
            $table->foreign('id_armario')->references('id')->on('armario')->onDelete('cascade')->primary();
        });

        Schema::table('armario', function (Blueprint $table) {
            $table->foreign('id_cliente')->references('id')->on('clientes')->onDelete('cascade')->primary();
        });

        Schema::table('produtos_quimicos_pictogramas', function (Blueprint $table) {
            $table->foreign('id_produtos_quimicos')->references('id')->on('produtos_quimicos')->onDelete('cascade')->primary();
        ...
        //Falta pictogramas_codPrudencia, codPrudencia
    }
