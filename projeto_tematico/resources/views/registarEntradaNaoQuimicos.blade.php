    ...
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">
          Registar a entrada não-químicos
        </h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Entrada/Não-Químicos</li>
        </ol>
      </div>
    </div>
  </div>
        ...
        <div class="row">
            <div class="card-body" style="display: block;">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Capacidade de embalagem</label>
                            <input type="number" class="form-control" id="#" placeholder="Digite a capacidade de embalagem...">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Tipo de embalagem</label>
                            <input type="text" class="form-control" id="#" placeholder="Digite o tipo de embalagem...">
                        </div>
                    </div>
                </div>
