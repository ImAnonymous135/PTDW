                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="select-search form-control" id="state" name="state">
                                        ...
                                        <option value="{{ $item->id }}.{{ $item->designacao }}">{{ $item->designacao }}
                                        </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="dataValidade" value={{ $date }}
                                        name="dataValidade">
                                </div>
                            </div>
                            <div class="col-sm-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control input-group-append" id="tipoEmbalagem"
                                        name="tipoEmbalagem">
