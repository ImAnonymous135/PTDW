                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="select-search form-control @error('state') is-invalid @enderror"
                                        id="state" name="state">
                        ...
                        <div class="row">
                            <div class="col-sm-1">
                                <div class="form-group">
                                    ...
                                    <select class="select-search form-control @error('sala') is-invalid @enderror"
                                        id="select-sala" name="sala">
                                        <option value=""></option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <select class="select-search form-control @error('operador') is-invalid @enderror" id="select-fornecedor" name="fornecedor">
                                        <option></option>
                                        @foreach ($fornecedores as $fornecedor)
                                        <option value="{{$fornecedor->designacao}}">{{$fornecedor->designacao}}</option>
                                        @endforeach
                                    </select>
                                    @error('fornecedor')
                                    <span class="invalid-feedback" role="alert">
