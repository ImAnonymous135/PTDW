            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="dataEntrada" value="22/12/2020"  name="dataEntrada" readonly>
                    </div>
                </div>
                <div class="col-sm-2">
                    <div class="form-group">
                ...
                <div class="col-sm-2">
                    <div class="form-group">
                        <label>{{ __('text.capacidadeEmbalagem') }} numero</label>
                ...
                <div class="col-sm-2">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="capacidadeEmbalagem" placeholder="" name="capacidadeEmbalagem">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" rows="3" maxlength="100" placeholder="" id="observacao" name="observacao"></textarea>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
